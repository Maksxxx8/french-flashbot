...
class LearningPlan:
    ...
    async def get_next_words_exercise(self, chat_id: str, lang: str, mode: Optional[str]=None) -> Optional[Exercise]:
        ...
        meaning = _to_scalar(row_item['meaning'] if 'meaning' in row_item else None, None)
        ...
        if 'test_flashcard' == mode:
            ...
            exercise = WordsExerciseLearn(word=row_item['word'], meaning=meaning, word_id=word_id, lang=lang, uilang=uilang,
